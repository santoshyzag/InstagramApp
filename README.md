...
# Project 1 - *Instagram App*

**Instagram App ** is an android app that allows a user to check out popular photos from Instagram. The app utilizes Instagram API to display images and basic image information to the user.
...
<img src='http://i.imgur.com/miTtXzR.gifv' title='Video Walkthrough' width='' alt='Video Walkthrough' />
